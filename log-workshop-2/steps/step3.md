Since this application is running over Docker container, in order to collect all monitoring data, the Datadog Agent runs as a container alonside the one of your application.
